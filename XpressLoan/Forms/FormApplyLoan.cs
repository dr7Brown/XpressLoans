...
{
    public partial class FormApplyLoan : MetroFramework.Forms.MetroForm
    {
        ...
        public FormApplyLoan(int customerID, string customerName)
        {
            InitializeComponent();
        ...
        private void FormApplyLoan_Load(object sender, EventArgs e)
        {
        ...
        private void purposeTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            txtPurposeTextCount.Text = purposeTextBox.Text.Length.ToString() + "/20";
        }
