...
namespace XpressLoan.Forms
{
    public partial class FormDeleteCustomer : Form
    {
        ...
        public FormDeleteCustomer(int cusID, string cusName)
        {
            InitializeComponent();
            customerID = cusID;
            customerName = cusName;
            lblUsername.Text = customerName;
        }
        ...
        private void deleteCustomer()
        {
            using (SqlConnection conn = new SqlConnection(ConnString.ConnectionString))
            {
                ...
                try
                {
                    ...
                    //Account
                    da.DeleteCommand = new SqlCommand("DELETE FROM tblAccount WHERE CustomerID = @CustomerID", conn, transaction);
